...
class TextlistFormater:
    ...
    def format_translations(to_format, entry):
        ...
        for lan in languages:
            if lan in to_format:
                translations.append((lan, CommentFormater.clean_comment_string(to_format[lan][entry])))
        return translations
    
    @staticmethod
    def format_comment(type, to_format):
        return [(TextlistFormater.format_textid(type, i), CommentFormater.clean_comment_string(s), TextlistFormater.format_translations(to_format, i))
